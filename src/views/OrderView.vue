        ...
        <div class="col-xl-4 order-xl-1">
          <div class="flex justify-end md-gap-x-2">
            <BsDropdownMenu placement="bottom-right" space="3">
              <BsButton color="primary" outlined title="Export order" size="sm"> Export </BsButton>
              <template #content>
                <BsListView>
            ...
            <BsButton color="primary" icon="add" icon-size="18" title="Add new order" size="sm">
              New Order
            </BsButton>
          </div>
        </div>
            ...
            <div class="col-md-6 col-xl-auto order-md-1">
              <div class="flex justify-end md-gap-x-1">
                <BsDropdownMenu space="1">
                  ...
                  <template #content>
                    <BsListView item-rounded style="width: 158px">
                      <BsListNav>
                        <BsListNavItem
                ...
                <BsDropdownMenu space="1">
                  ...
                  <template #content>
                    <BsListView item-rounded style="width: 138px">
                      <BsListNav>
                        <BsListNavItem
